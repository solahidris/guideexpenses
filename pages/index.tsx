...
const Home = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center pt-20 capitalize">
      
      <p className="font-bold capitalize text-2xl mb-4">guide expenses</p>

      <div className="flex flex-col border rounded shadow lg:max-w-xs w-full">
